...
void GeometrySahder::init(GLFWwindow* window) 
{
...
void GeometrySahder::input(GLFWwindow* window) {
...
void GeometrySahder::randerCube(const Shader& shader) {
...
void GeometrySahder::randerPlane(const Shader& shader) {
    glm::mat4  model = glm::mat4(1.0f);
    // 向下平移
