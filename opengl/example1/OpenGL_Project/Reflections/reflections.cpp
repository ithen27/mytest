...
void Reflections::init(GLFWwindow* window) 
{
...
void Reflections::input(GLFWwindow* window)
{
...
void Reflections::randerCube(const Shader& shader)
{
...
void Reflections::randerPlane(const Shader& shader) 
{
	glm::mat4  model = glm::mat4(1.0f);
	// 向下平移
